...
var Game = new function() {                                                                  
  ...
  // Handle Input
  var KEY_CODES = { 37:'left', 39:'right', 38:'up', 40:'down', 32 :'fire', 13:'enter' };
  this.keys = {};
...
var SpriteSheet = new function() {
  ...
  this.draw = function(ctx,sprite,x,y,frame) {
    ...
    if(typeof this.map[sprite].size != 'undefined') //Solo cambiamos el valor si hemos definido el size
      size = this.map[sprite].size;
    else
      size = 1;
...
var GameBoard = function() {
  ...
  // Add a new object to the beginning of the object list
  this.addToBegin = function(obj) { 
    obj.board=this; 
...
Sprite.prototype.draw = function(ctx) {
  /*
  if(this.sprite == 'frog'){ //Modificación para rotar la rana
...
var Timer = function() {
  ...
  this.draw = function(ctx) {
    ...
    var txt = "Time: " + Game.sec;
    Game.ctx.fillText(txt,10,40);
    Game.ctx.restore();
